...
const validateAttitudes_1 = require("../validators/validateAttitudes");
// import { requireAuthentication } from '../utils/authHelpers';
node_1.default.Cloud.beforeSave('attitudes', async (request) => {
    try {
        ...
        const error = await (0, validateAttitudes_1.validateAttitudes)(data, isNew);
        if (error) {
...
//# sourceMappingURL=attitudesTriggers.js.map